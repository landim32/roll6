...
public class ImageServiceTests
{
    ...
    public ImageServiceTests()
    {
        ...
        _storage.Setup(s => s.GetUrl("0123456789abcdef0123456789abcdef.png")).Returns("https://bucket/simple-tabletop/0123456789abcdef0123456789abcdef.png");
    ...
    public async Task Upload_ValidPng_ReturnsFileNameAndUrl()
    {
        ...
        result.Url.Should().Be("https://bucket/simple-tabletop/0123456789abcdef0123456789abcdef.png");
    }
