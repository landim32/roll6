...
public class MapServiceTests
{
    ...
    public async Task ListByCampaign_ByApprovedParticipant_ReturnsMaps()
    {
        ...
        var result = await _service.ListByCampaignAsync(OTHER_USER_ID, 10, new SimpleTabletopMap.DTO.Common.PageQuery());
    ...
    {
        var act = () => _service.ListByCampaignAsync(OTHER_USER_ID, 10, new SimpleTabletopMap.DTO.Common.PageQuery());
