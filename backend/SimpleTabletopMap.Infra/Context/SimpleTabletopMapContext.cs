...
namespace SimpleTabletopMap.Infra.Context;

public class SimpleTabletopMapContext : DbContext
{
    private const string TIMESTAMP = "timestamp without time zone";

    public SimpleTabletopMapContext(DbContextOptions<SimpleTabletopMapContext> options) : base(options)
    {
    }
